...
recipe "rjg_utils::install_roles_and_features", "Installs one or many Windows 2008 roles and features, or Windows 2003 components using the rjg_utils::features_and_roles_list as input."
recipe "rjg_utils::reset_roles_and_features_list", "An escape hatch to reset the list of roles and features or components."
